...
model_1_data = pd.read_csv("data/model_selection/user_data_model_18.csv")
model_2_data = pd.read_csv("data/model_selection/user_data_model_19.csv")
model_3_data = pd.read_csv("data/model_selection/user_data_model_20.csv")
model_4_data = pd.read_csv("data/model_selection/user_data_model_21.csv")
pastuserID = 0
...
try:
    for i in range(len(model_1_data)):
        ...
        gen_ans = [m1.answer, m4.answer]#[m1.answer, m2.answer, m3.answer, m4.answer]
        ...
        "m18" : m1.answer, "m21" : m4.answer, "point_to_model" : curr_point }, ignore_index=True)
        
except Exception as e:
    print(e)
finally:
    print(evaluation_score)
    new_df.to_csv('model_selection_automatic_eval_4.csv', index=False)